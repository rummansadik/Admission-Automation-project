...
#     path('admin-add-university', views.AdminUniversityCreateView.as_view(),
#          name='admin-add-university'),
    path('admin-view-course', views.admin_view_course_view,
         name='admin-view-course'),
    path('admin-view-university', views.admin_view_university_view,
         name='admin-view-university'),
    path('delete-course/<int:pk>', views.delete_course_view, name='delete-course'),
    path('delete-university/<int:pk>',
         views.delete_university_view, name='delete-university'),
